...
import (
	...
	queuev1alpha1 "github.com/yolo3301/kcrd/pkg/apis/queue/v1alpha1"
	versioned "github.com/yolo3301/kcrd/pkg/client/clientset/versioned"
	internalinterfaces "github.com/yolo3301/kcrd/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/yolo3301/kcrd/pkg/client/listers/queue/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.QueueV1alpha1().Queues(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.QueueV1alpha1().Queues(namespace).Watch(options)
			},
		},
		&queuev1alpha1.Queue{},
		resyncPeriod,
